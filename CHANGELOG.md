...
## [1.2.0](https://github.com/jasonkneen/vibesdk/compare/v1.1.0...v1.2.0) (2025-11-09)
...
* add actionKey tracking for inference calls and rate limiting ([226441e](https://github.com/jasonkneen/vibesdk/commit/226441eda591b94cbf259e04f5b216eb74eae7bf))
* add app visibility toggle and shareable link functionality to deployment controls ([692215d](https://github.com/jasonkneen/vibesdk/commit/692215d388ab19ecd1871ac7e1e0303555660b6a))
* add auto-scroll behavior to chat messages container ([6919820](https://github.com/jasonkneen/vibesdk/commit/69198204c7d972261b17e4177980b5602d9a5ff5))
...
* add better streaming tool call accumulation and debug logging ([67360fe](https://github.com/jasonkneen/vibesdk/commit/67360fef74a033fc898b7cf2e425218e0278d269))
...
* add conciseness requirement to agent instructions ([262d48f](https://github.com/jasonkneen/vibesdk/commit/262d48fdeddeca349430e36035a5a8da2ec6c662))
...
* add Custom style option to template selector ([76a4960](https://github.com/jasonkneen/vibesdk/commit/76a4960fe1ed5cba209be4618408748d7bff2d78))
...
* add deploy to Cloudflare button in phase timeline header ([bea0bcd](https://github.com/jasonkneen/vibesdk/commit/bea0bcdc09a408a0fdea6f5e27cd308bc57f2fb2))
...
* add discover nudge UI with arrow and font styling ([a33f29b](https://github.com/jasonkneen/vibesdk/commit/a33f29b153b44246a3c74479ce204193bb8a8ea4))
...
* add dynamic platform status banner with changelog dialog in global header ([2f24af2](https://github.com/jasonkneen/vibesdk/commit/2f24af2cedf0b2f0e6701838295dbd97d394f5b5))
* add ESM module support and improve error handling in worker deployment ([dc2ee30](https://github.com/jasonkneen/vibesdk/commit/dc2ee30a13f32bdb47434bcdde0397a9ead3a5e2))
* add exponential backoff and max retries constant for deployment failures ([cbf1220](https://github.com/jasonkneen/vibesdk/commit/cbf12206a12a45e400a64fbc278d5cbbf3521241))
...
* add indexes for app views and stars by app_id and timestamp ([87dedbe](https://github.com/jasonkneen/vibesdk/commit/87dedbeef5379e1023e09e33749b5895d6204ddd))
...
* add issues field to DeterministicCodeFixCompletedMessage interface ([f7689fd](https://github.com/jasonkneen/vibesdk/commit/f7689fdc1c2b53427928a6c155dd0b1f11ac3d74))
* add latest Gemini model variants ([134f518](https://github.com/jasonkneen/vibesdk/commit/134f518cb42fc77ff2e402dc684afd02f18c607a))
* add latest Gemini model variants and reorganize AI model enum groupings ([a6a2b5d](https://github.com/jasonkneen/vibesdk/commit/a6a2b5df3d8698b28957cdc21a5f6c0ba12663aa))
...
* add localhost:8787 to allowed CORS origins in dev environment ([88c1919](https://github.com/jasonkneen/vibesdk/commit/88c1919e7ff52f986acfa1553a00f9b00e873d1e))
...
* add preview expiration handling and update deployment messaging ([74b16da](https://github.com/jasonkneen/vibesdk/commit/74b16daee96dc86dd72091ea49c19b79f252f8a4))
...
* add pulsing edge animation to indicate active phase progress ([49daa1d](https://github.com/jasonkneen/vibesdk/commit/49daa1ddd4ad7a6b66d23c1b0adc78677478ec6f))
...
* add retry mechanism for sandbox deployment failures with max 3 attempts ([1c110e0](https://github.com/jasonkneen/vibesdk/commit/1c110e0cbf443b74f01a8a9dd4aa8772ed3f479e))
* add safe JSON stringification with circular reference and Error object handling ([6e6dcd2](https://github.com/jasonkneen/vibesdk/commit/6e6dcd2d155ef3064bc60c33879c32334f76b2c0))
* add Sentry frontend integration ([72455ff](https://github.com/jasonkneen/vibesdk/commit/72455ffc53b2cb527bcd317f4bae89404795c674))
* add Sentry frontend integration ([c6755a2](https://github.com/jasonkneen/vibesdk/commit/c6755a2e85a7b3c49e1f73aa9f9a9570c9fd09eb))
* add sort persistence and auto-collapse sidebar on new build ([332041a](https://github.com/jasonkneen/vibesdk/commit/332041acc160128a015e65719590fea64e11b16e))
...
* add support for backward compatibility flags in templates ([506a7ca](https://github.com/jasonkneen/vibesdk/commit/506a7cabb6578583a11ca4b3c1a14fcc1bca02b1))
* add support for separate preview domain in deployment system ([057ffa5](https://github.com/jasonkneen/vibesdk/commit/057ffa5bbd6d2969d83381531e6f49b20f5ed263))
* add support for user-suggested phase generation and forbid image generation ([0ab6501](https://github.com/jasonkneen/vibesdk/commit/0ab6501eb3a074efb37967b3d2a92ad8e27f74fb))
...
* add tool depth limit and conversation context compactification ([5ba30b9](https://github.com/jasonkneen/vibesdk/commit/5ba30b9cb384bc2c519462c436f37dc2c7536f72))
...
* add word counter and 4000 word limit to chat input ([33f5f50](https://github.com/jasonkneen/vibesdk/commit/33f5f50cc23fe6a5e812ba865b30c968b6663a9d))
* added cloudflared tunnels for local dev + docs ([745cd2a](https://github.com/jasonkneen/vibesdk/commit/745cd2ac8893c44e29f5e0cabc74938ea0004c3e))
* added guardrails that impact on multiple tiers for policy ([cf455b5](https://github.com/jasonkneen/vibesdk/commit/cf455b5f465eaba4766008467a2141efed82f91b))
* added guardrails that impact on multiple tiers for policy ([6c1d1ec](https://github.com/jasonkneen/vibesdk/commit/6c1d1ec23c789fcc47d40087185bb061c560890c))
...
* build lint/tsc cache in background on sandbox init ([c89e655](https://github.com/jasonkneen/vibesdk/commit/c89e6552899b591295a7969032cb58ff05881900))
* bump wrangler versions and default to sandbox-3 ([20f1be9](https://github.com/jasonkneen/vibesdk/commit/20f1be99f83d1d3731ccee5c9c1a2460fc51fec1))
* cleaner sandbox instanceId generation + toast notifs ([7a667a7](https://github.com/jasonkneen/vibesdk/commit/7a667a7ff8d29bcfadeea60d6e2e7c067c875d37))
...
* display tool execution status in chat messages with live updates ([efef517](https://github.com/jasonkneen/vibesdk/commit/efef517abe2c2256edcd40a65c95f09911c20588))
...
* doc and script for local setup + local fixes ([1bcb83b](https://github.com/jasonkneen/vibesdk/commit/1bcb83b65633a35f254d306ae184d4f7d9703ff9))
* enable Sentry error reporting with CF Access auth and improved logging integration ([fa24bfb](https://github.com/jasonkneen/vibesdk/commit/fa24bfbb1968f11e9b66fac32ed78366ae51e8dd))
* enhance app list animations and infinite scroll loading experience ([70f0adc](https://github.com/jasonkneen/vibesdk/commit/70f0adceec88ce948d8bc53659809ad9e30052d4))
...
* enhance prompts for react errors ([9674413](https://github.com/jasonkneen/vibesdk/commit/96744135e23124294874ef483bfadf1602676692))
...
* fortification against rerender loops ([fbda105](https://github.com/jasonkneen/vibesdk/commit/fbda10566cc717c8a9628e260de390154bbf38f7))
* General cleanups and patches ([8133d22](https://github.com/jasonkneen/vibesdk/commit/8133d2218f774c6f6daf126a5626c63a09dd283e))
...
* implement D1 read replicas for optimized database queries ([2e7110a](https://github.com/jasonkneen/vibesdk/commit/2e7110af58201ef92181e126bee072006df3a73e))
...
* implement file tree builder and pass in project context ([2dd4b2a](https://github.com/jasonkneen/vibesdk/commit/2dd4b2a66a2f03ac9adc7845b6e2f5945d5b792d))
...
* improve file tree serialization and error formatting ([ddcfa3a](https://github.com/jasonkneen/vibesdk/commit/ddcfa3ab315cec5c363553395b6bb67ca5402b6d))
...
* include runtime errors in conversation context ([e71b9f5](https://github.com/jasonkneen/vibesdk/commit/e71b9f5bf0a7713017428b5c6204214473316fac))
...
* initial integration of images support in build/chat ([62d024f](https://github.com/jasonkneen/vibesdk/commit/62d024f92e20043eaee8433e91c321f789eed821))
...
* pass user suggestions to phase impl too ([5b359e7](https://github.com/jasonkneen/vibesdk/commit/5b359e749fc1f7cefcce57a6d7517a55a7949cec))
* phase bar on chat scroll + phase timeline consolidation ([e6c3f26](https://github.com/jasonkneen/vibesdk/commit/e6c3f2629f821baf670ca5568dd5cf86680e1060))
...
* redesign app tabs + fixed dark mode banner color ([981c18d](https://github.com/jasonkneen/vibesdk/commit/981c18d7243d96c840814c7f5d135d6ee8748333))
* reimplement tool calling pipeline for dynamic tools ([56ca8c7](https://github.com/jasonkneen/vibesdk/commit/56ca8c7f372a071f77ef69c0c22640c84789a125))
...
* replace chat input with auto-resizing textarea supporting multiline messages ([8e295e6](https://github.com/jasonkneen/vibesdk/commit/8e295e6f265b113b2b1061e622cddbb00929c3f3))
* replace fork count with view count in app card stats display ([f8a4823](https://github.com/jasonkneen/vibesdk/commit/f8a4823c401df1220c9942490846bf094b4f06d9))
* replace XML parsing with direct tool-based conversation processing ([53afb15](https://github.com/jasonkneen/vibesdk/commit/53afb15d25765f2c7ccae534811b5b25939b5a86))
* restrict Sentry error tracking to API endpoints only ([f53267d](https://github.com/jasonkneen/vibesdk/commit/f53267dc042f1e8cb683a4961b36ae46783a89ec))
...
* rewritten process monitoring - simpler, more reliable ([cf99657](https://github.com/jasonkneen/vibesdk/commit/cf996574f73c0b991d19079c4ea9b0dd531af2d7))
...
* show discoverable apps preview on homepage ([3f3b052](https://github.com/jasonkneen/vibesdk/commit/3f3b0522ba2790eceb0e2197c9d42fdf0867d186))
* show discoverable apps preview on homepage ([5e05841](https://github.com/jasonkneen/vibesdk/commit/5e05841eaec965c4b57340560e440d8f5879fa99))
* show toast on agent session fail ([9a9e401](https://github.com/jasonkneen/vibesdk/commit/9a9e401c57c34612d833ace72e1d86b3533a2305))
...
* store and pass last diff to allow revert ([95f739e](https://github.com/jasonkneen/vibesdk/commit/95f739eebc1bb09340395cffedaa950ad1d77c7d))
...
* strip system context tags from user messages and UI ([87a44df](https://github.com/jasonkneen/vibesdk/commit/87a44df29dfb70e26541262cd77fb1b88da7bff2))
...
* wrap app cards and menu items in anchor tags for proper URL routing ([89a40f4](https://github.com/jasonkneen/vibesdk/commit/89a40f41d596c49dd66d8b9031bae1e0215f3c41))
...
* adjust rate limit period from 1 hour to 10 minutes for better request throttling ([6aadd5f](https://github.com/jasonkneen/vibesdk/commit/6aadd5f082479b8b8138b94963a24b06eb609887))
* align prompts to adhere better to user suggestions ([b7eff13](https://github.com/jasonkneen/vibesdk/commit/b7eff133fd5af21959eb52f42ceea26a8f53abaf))
...
* big asset fetching corruption + unicode issue ([7e1d70e](https://github.com/jasonkneen/vibesdk/commit/7e1d70ea92df0435a432987111fcd621d90cfffb))
* big asset fetching corruption + unicode issue ([b2a317d](https://github.com/jasonkneen/vibesdk/commit/b2a317d5dd0063006251ad16b6b83e38a7cc079d))
...
* check pending user inputs before finalizing phase generation ([595f4f2](https://github.com/jasonkneen/vibesdk/commit/595f4f231932659764744f802d1b3e0f2324cca8))
...
* clean up error stack traces by filtering out non-typescript lines ([ef4f174](https://github.com/jasonkneen/vibesdk/commit/ef4f17497fa1f622006b428606f7a6378b55a9c8))
* clear user suggestions after phase execution to prevent duplicate processing ([40f39ab](https://github.com/jasonkneen/vibesdk/commit/40f39abb42db2d982fe245dabc316b4538aa1bb1))
...
* copy URL button was not working ([1ff6122](https://github.com/jasonkneen/vibesdk/commit/1ff612202a83672ecf8e3415b4778357c7662837))
* copy URL button was not working ([9a722e3](https://github.com/jasonkneen/vibesdk/commit/9a722e3c3b2b9b99d6c6e0fef62fe13469b6071b))
...
* enhance code analysis and fix strategies for deterministic code-fixer ([589ca8f](https://github.com/jasonkneen/vibesdk/commit/589ca8f4175434b723c3a324046a0e8c2e3c38e6))
* enhance deterministic code fixer to handle external module installation and improve tool execution feedback ([5baba34](https://github.com/jasonkneen/vibesdk/commit/5baba3437ad6ff5272684bdd29d112f071abd6ed))
...
* file patch extension check for undefined ([de455e6](https://github.com/jasonkneen/vibesdk/commit/de455e66d03f015a4e32629c3367f58af45087be))
...
* fixed build errors ([d9f865b](https://github.com/jasonkneen/vibesdk/commit/d9f865be2a9759119690c78190b24e70a36b80b1))
...
* fixed wrangler configs ([fabde00](https://github.com/jasonkneen/vibesdk/commit/fabde007be799f94c0c24b8891bf90b22198eed3))
...
* get images from url param and pass it ([0be1f25](https://github.com/jasonkneen/vibesdk/commit/0be1f25c1d8d6e205b68897909bf421ac797acc7))
...
* handle missing projectUpdatesAccumulator in state and add missing deployer config options ([43da2c8](https://github.com/jasonkneen/vibesdk/commit/43da2c86545d0a69a98dd7b1739c8bb79d2b774a))
...
* handle zone detection failure and preserve existing zone info in wildcard routes ([a79629c](https://github.com/jasonkneen/vibesdk/commit/a79629c369f2d4de5bfe58267eca76fa960206ec))
* improve rate limit error handling and logging across API client and WebSocket ([662095f](https://github.com/jasonkneen/vibesdk/commit/662095f68e823bbf0462684a8a6f9b3936082b0c))
* improved user convo agent's prompt + reduced its max_tokens ([51db49e](https://github.com/jasonkneen/vibesdk/commit/51db49ec1f8ba62784791dfd957f1de762475293))
...
* minor dark mode fixes, change homepage header ([30dabff](https://github.com/jasonkneen/vibesdk/commit/30dabff4b227922d27568c242830e587fb769c07))
* minor dark mode fixes, change homepage header ([273c079](https://github.com/jasonkneen/vibesdk/commit/273c079736c6e5fd84198174c0288b79e3fa356e))
...
* pagination not working on mode change + consolidated fetches ([c4a86b5](https://github.com/jasonkneen/vibesdk/commit/c4a86b56bb74e4cf64236c24f53c1e2c97831c72))
* pass noToast param when retrying CSRF token refresh and add rate limit toast ([d79763a](https://github.com/jasonkneen/vibesdk/commit/d79763af9241d4e92a550504420b60d44bde148d))
* pass user suggestions to phase implementation too for better reliability ([f8e027f](https://github.com/jasonkneen/vibesdk/commit/f8e027fc7656ab9b06354b80e3cdce31e53ff764))
* prevent concurrent sandbox deployments and improve instance cleanup ([2eb27b1](https://github.com/jasonkneen/vibesdk/commit/2eb27b1b15d7529ed83d99819230d7edc4ee8d17))
* prevent further review cycles by tracking review state ([b1c749c](https://github.com/jasonkneen/vibesdk/commit/b1c749c0b726ccdd204ff36dacba4918098fd12e))
...
* prevent unnecessary status resets when cached status exists ([625e015](https://github.com/jasonkneen/vibesdk/commit/625e015bb5ee5f4a746f6a01abe43ccd3e01cd24))
* prompt react fixes ([0c3a841](https://github.com/jasonkneen/vibesdk/commit/0c3a841b72497bd97169de907a806d8527ff0abd))
* properly sanitize projectName causing unresolve issues ([3ef0ce9](https://github.com/jasonkneen/vibesdk/commit/3ef0ce9a72b5182f7e23213d022f08b0711a0c83))
* reduce enhanced sandbox instance resources to 4cpu 4gb ([788fdcd](https://github.com/jasonkneen/vibesdk/commit/788fdcd003886629c6e5c57e54d1efdb24c4a1e5))
...
* remove any type assertion in chat and reduce API rate limit to 1000 requests per minute ([1e41df3](https://github.com/jasonkneen/vibesdk/commit/1e41df329758c2aff857fbddcc26ac8aaed0b868))
* remove background static analysis from setupInstance ([0744b12](https://github.com/jasonkneen/vibesdk/commit/0744b12a4b750f4c3c315dd361ef741c27a0f34a))
...
* remove unnecessary quotes in Cloudflare deploy URL ([c57606a](https://github.com/jasonkneen/vibesdk/commit/c57606a30cc308ffc1a7c713ae46a769f8385157))
* remove unnecessary quotes in Cloudflare deploy URL ([f96be72](https://github.com/jasonkneen/vibesdk/commit/f96be72c1eb3dedb54dac7a064f8c42a777e90ad))
* remove unused forCodegen parameter from project setup template ([4b24ea2](https://github.com/jasonkneen/vibesdk/commit/4b24ea27ab07b1c91b01f5f8942bfba32eec369b))
* remove unused util giving SAST error ([577ff98](https://github.com/jasonkneen/vibesdk/commit/577ff983e43dfa8959067b67314cdc7e0d9bf092))
...
* reset sandbox sessionId when container service disconnects ([849872a](https://github.com/jasonkneen/vibesdk/commit/849872abd7ec844edd21e380ebeb011dbfd83909))
* resolved command history growth issue ([0d23ca8](https://github.com/jasonkneen/vibesdk/commit/0d23ca8db76ffa6ce8254f72b9b739460caa9508))
* restrict agent preview endpoint to authenticated users only ([4eef652](https://github.com/jasonkneen/vibesdk/commit/4eef652cd26e2f2aa05eb948c0e8f896a3522abd))
* Return correct csrf validation error format ([db4d162](https://github.com/jasonkneen/vibesdk/commit/db4d16279c2bf2390eade27ab7ffeb4ab808c30c))
...
* temp overflow fix ([5825fa4](https://github.com/jasonkneen/vibesdk/commit/5825fa4a132fe1843147f9ebadcd9fe90a9b03de))
* truncate project names to 20 chars and handle LLM rate limits ([7ee2291](https://github.com/jasonkneen/vibesdk/commit/7ee2291038a61c3f3dd3928fe84c3e26f180c3f9))
...
* typo of precedence in phase generation prompt ([8485637](https://github.com/jasonkneen/vibesdk/commit/8485637c151d9acec0d879b973a91a0bb53dbc4b))
* update default data directory path to use ./.data instead of ./data ([a4eb812](https://github.com/jasonkneen/vibesdk/commit/a4eb812e1d3dc6322af208b5091b3ea84d3a9380))
* update dockerfile with cloudflared installation ([0d18e0c](https://github.com/jasonkneen/vibesdk/commit/0d18e0c51b01d279e2eb803c9922725e02e88258))
...
* use CUSTOM_DOMAIN env var instead of hostname for r2 screenshot urls ([e27c47f](https://github.com/jasonkneen/vibesdk/commit/e27c47fa9943691f3aa4c55ec451c7df6f09cd6f))
* use CUSTOM_DOMAIN env var instead of hostname for r2 screenshot URLs ([33eb6fc](https://github.com/jasonkneen/vibesdk/commit/33eb6fc4bfb4bdc9eaae3d98050986311f53ab1d))
...
* optimize app analytics queries by combining multiple queries into two batched operations ([101e495](https://github.com/jasonkneen/vibesdk/commit/101e495004295c28bcffef7578d9f185571d35c1))
