...
## [1.5.0](https://github.com/jasonkneen/vibesdk/compare/v1.4.0...v1.5.0) (2025-12-23)


### Features

* add abort signal support to inference operations ([f3e545e](https://github.com/jasonkneen/vibesdk/commit/f3e545e742b7b4cedb4c74b3af9501327ee8a8b3))
...
* add conversation reset functionality with confirmation dialog ([5ebb714](https://github.com/jasonkneen/vibesdk/commit/5ebb714087367724785f97991c9c5fbe9587e83a))
...
* add deep debug session management with state persistence and wait tools ([e60694f](https://github.com/jasonkneen/vibesdk/commit/e60694f6334b2c05acd1c7147650fc88c9adbd61))
* add deep debugger transcript UI with collapsible tool results ([95ed92f](https://github.com/jasonkneen/vibesdk/commit/95ed92f0111bab5f78318a810c9c965afc38a388))
...
* add duration filter option for log retrieval in sandbox ([4579da2](https://github.com/jasonkneen/vibesdk/commit/4579da2530a45d91294fd108d9937254d93e68de))
...
* add force refresh mechanism for preview deployments ([796e34d](https://github.com/jasonkneen/vibesdk/commit/796e34d3459657502599bdbfdeddc1144289c0e3))
* add generate_files tool for creating new files and full rewrites ([52d917f](https://github.com/jasonkneen/vibesdk/commit/52d917f2f6ff39f2ea047f494cf579e28dab9a31))
...
* add inference cancellation support with AbortController ([6e752c2](https://github.com/jasonkneen/vibesdk/commit/6e752c214197ec755c988ee0308721d1f04b50fb))
...
* add previous debug session context and improve error handling in debugging tools ([45ac910](https://github.com/jasonkneen/vibesdk/commit/45ac9105ad920e36cd7b284a050a414c1913a2a6))
...
* add retry logic for process health check in sandbox service ([3284afe](https://github.com/jasonkneen/vibesdk/commit/3284afe0201f591776e348ffb0666bf9e4a5c494))
...
* add stop generation button and handle cancelled state in phase timeline ([3cd7cab](https://github.com/jasonkneen/vibesdk/commit/3cd7cabed64f8cbd012f12f63b5be6355b9a51e4))
* add streaming support to deep debugger and enhance logs tool with truncation ([1bdb1e7](https://github.com/jasonkneen/vibesdk/commit/1bdb1e7e97c6a18ae3c3a2c69b8c14e6fdd65a19))
...
* add tool result field to websocket messages and update event handling ([41fab81](https://github.com/jasonkneen/vibesdk/commit/41fab814b6991895da1cd9eccb2acac00a6f79a4))
* add uploads routes + fix filename in r2 ([6a41be1](https://github.com/jasonkneen/vibesdk/commit/6a41be1d0d19317146c07ac2bbaab90d46bed0df))
...
* add wait_for_generation tool and enhance tool call result handling ([92f4e0e](https://github.com/jasonkneen/vibesdk/commit/92f4e0e5192efd8ca0154e7d28ba6fd1f046a8da))
...
* allow CORS for localhost during development ([c575baa](https://github.com/jasonkneen/vibesdk/commit/c575baae7465200b02cea2bbd229280351c58607))
* alter template schema to return map instead of list of files ([fad85df](https://github.com/jasonkneen/vibesdk/commit/fad85df3b1385426fb3892d74fb97f9f4dd2d52d))
* always upload images to r2, best-try on CF Images ([5797f13](https://github.com/jasonkneen/vibesdk/commit/5797f135679ba5c6ea0e14a73b79eee9b6567d56))
...
* display completion message when entering finalization phase ([1365eeb](https://github.com/jasonkneen/vibesdk/commit/1365eebae9fc150a91d048bae2e6b5cf11cda350))
...
* enhance debugging tools with user interaction handling and runtime error detection ([b144e2c](https://github.com/jasonkneen/vibesdk/commit/b144e2c8b63bdf803f28b0ad85f8183ae6281316))
...
* fix frontend types + proper load convo state ([3d6cc16](https://github.com/jasonkneen/vibesdk/commit/3d6cc16432e96a6b7a5b2e2bbc8084bb5fe419c0))
...
* implement collapsible tool result viewer with JSON formatting support ([9ae4640](https://github.com/jasonkneen/vibesdk/commit/9ae464050cad6a55aa10f87df01f0739ccc00364))
* implement daily rate limit for API and LLM calls ([d8f0ba0](https://github.com/jasonkneen/vibesdk/commit/d8f0ba017b0a41ba7727ca7546c2fdd5d18fbb7f))
* implement message deduplication to prevent duplicate assistant responses ([0256634](https://github.com/jasonkneen/vibesdk/commit/0256634a6a042d7136a6b9bcda80ea92a8d1478c))
* implement model-specific rate limit increments for LLM calls ([cc1de09](https://github.com/jasonkneen/vibesdk/commit/cc1de09e4428e4456e9a6d26fd556fffce1a8285))
* implement project name and blueprint update tools ([871548f](https://github.com/jasonkneen/vibesdk/commit/871548febfdcf6efd5d3fade563f8a7738f64e08))
...
* in memory get template details ([e01f067](https://github.com/jasonkneen/vibesdk/commit/e01f067969e1ad414257a312d7c887216c06fe46))
* increase instance resources and improve GitHub file export handling ([bfa4855](https://github.com/jasonkneen/vibesdk/commit/bfa48552cb8e03123dc341ac79cfab5d307e1120))
...
* initial draft of ai gateway proxy for user apps ([79505a6](https://github.com/jasonkneen/vibesdk/commit/79505a674b5a8f5a1979a0d1d0e60b1d28b2da8b))
* initial implementation of deep debugging agent ([520c2f6](https://github.com/jasonkneen/vibesdk/commit/520c2f61fc5d6a012c45a5cb487fc728e2be3fb4))
...
* more prompt tweaks for react/frontend ([866c881](https://github.com/jasonkneen/vibesdk/commit/866c881612adcbf1f658d63d20caeddee42c6602))
* more prompt tweaks, clarifications and build fix ([e54ea92](https://github.com/jasonkneen/vibesdk/commit/e54ea92c4f23e2c65214293cce23376d1162c0bf))
...
* Only enable ai proxy if jwt secret is set ([c40cb7c](https://github.com/jasonkneen/vibesdk/commit/c40cb7c958c072fbb1f2b5a9aef4611044407a5c))
...
* origin validation for openai proxy ([297b918](https://github.com/jasonkneen/vibesdk/commit/297b918e09d9beee4ba236f01951f956530a599b))
...
* prompt optimizations and alignment ([ac99a15](https://github.com/jasonkneen/vibesdk/commit/ac99a15994bb882deff6e0bde6d3388401961bf6))
...
* redact older phase details to optimize context length in prompts ([2cd720e](https://github.com/jasonkneen/vibesdk/commit/2cd720ea26e6c03dcdeb250b4d93546da1f52d91))
...
* sandboxsdk 0.4.3 port + in-memory template details zip extraction ([fd63813](https://github.com/jasonkneen/vibesdk/commit/fd638136bc7261869fefbef2692ec488adabc5d9))
* simplify GitHub push by passing file content directly instead of reading from sandbox ([66911fd](https://github.com/jasonkneen/vibesdk/commit/66911fd49e5c738670bc7c090b7c2961ade4d369))
...
* store full histories in separate DO table ([429b03b](https://github.com/jasonkneen/vibesdk/commit/429b03b0d9ff1963c0f03d141c7a4f14726a113e))
...
* true convo compactification + archive to r2 ([eb81e9a](https://github.com/jasonkneen/vibesdk/commit/eb81e9aca3ec52cca319fc3cbe8abb2945658a23))
...
* uncomment fast code fixers for optional use ([cff2213](https://github.com/jasonkneen/vibesdk/commit/cff2213d310e2d4f7267d81310bbc1616c6dbaa7))
...
* add missing await for async getFullState call in getAgentState function ([b0afd15](https://github.com/jasonkneen/vibesdk/commit/b0afd1533f736976367e8a3585a7d260d76fd8c4))
...
* build errors ([3898da4](https://github.com/jasonkneen/vibesdk/commit/3898da495ec78526b36bf8c6657d5b89d45cefac))
...
* code debugger prompt improvements ([06375ce](https://github.com/jasonkneen/vibesdk/commit/06375ce09891d311acc8b283391d2378a50f35f0))
...
* disabled tracing causing deployment failures for non-GA ([1fa292e](https://github.com/jasonkneen/vibesdk/commit/1fa292ea92642992c867ee0a004fe1ed71a80c79))
...
* ensure tool messages are preserved with their matching assistant tool_calls during conversation compactification ([78fe339](https://github.com/jasonkneen/vibesdk/commit/78fe33936649039cb5adcd98dd01f0987f3c0891))
...
* fileRegeneration was using realtimeCodeFixer's model config ([989aa1b](https://github.com/jasonkneen/vibesdk/commit/989aa1bf9c649558bd4aa959c906cf438be29ef6))
...
* finish posting to files map ([b73557e](https://github.com/jasonkneen/vibesdk/commit/b73557e4ed141191aba31a1fd6dceb7cbb86ec14))
...
* handle missing sandbox instance by returning empty issues object ([1259176](https://github.com/jasonkneen/vibesdk/commit/1259176c3b77500c4d145207f33d4a29cad20d74))
* handle parent dir creation in sandbox ([262bf69](https://github.com/jasonkneen/vibesdk/commit/262bf691ace3b66212128f18278e8f9fe348a0ec))
...
* increase deployment retry interval and remove redundant 422 retry logic ([d8c65d0](https://github.com/jasonkneen/vibesdk/commit/d8c65d0f4a968ff3249c06b7189fca65c2d97f59))
...
* prevent null ruleId in ESLint diagnostic messages by providing empty string fallback ([b76d000](https://github.com/jasonkneen/vibesdk/commit/b76d000b919ddf4cdeb36891afa6078325f8e59c))
...
* prevent reuse of aborted controllers and improve sandbox deployment resilience ([d5092b0](https://github.com/jasonkneen/vibesdk/commit/d5092b0c1757071efedd9c5a10677691e5497040))
...
* prompt react fixes ([0c3a841](https://github.com/jasonkneen/vibesdk/commit/0c3a841b72497bd97169de907a806d8527ff0abd))
...
* remove hardcoded models ([b98f862](https://github.com/jasonkneen/vibesdk/commit/b98f86280dd802cb226dd2d7e836e6ee8b713b5e))
...
* reverted some changes - quality decreased ([5e43ab5](https://github.com/jasonkneen/vibesdk/commit/5e43ab54af58924fc7045757e0cf02f7a1192213))
...
* simply use images rest api for uploading images ([b97fb68](https://github.com/jasonkneen/vibesdk/commit/b97fb683f62016658cc9bb332af0c636132fd4d7))
...
* store history reliably + user images in r2 ([47ae9e4](https://github.com/jasonkneen/vibesdk/commit/47ae9e48c825ea2d88f55a4c9122d10214ac57f1))
...
* typo in provider ([439f3ab](https://github.com/jasonkneen/vibesdk/commit/439f3abc18726919e27649058f44ef03974a25ce))
* typo in setup.ts ([64f7e99](https://github.com/jasonkneen/vibesdk/commit/64f7e99ff8ca542469c882dec872260055b4f36e))
...
* use correct error field in deployment failure toast message ([dcf98a4](https://github.com/jasonkneen/vibesdk/commit/dcf98a4240447f79d5612d8f92284902fc144846))
* use instance metadata from memory cache! ([fb8cd1b](https://github.com/jasonkneen/vibesdk/commit/fb8cd1b6506cc602ae7560116081da77d932fa1b))
...
* reuse image bytes buffer for both Cloudflare Images and R2 uploads ([bb3de20](https://github.com/jasonkneen/vibesdk/commit/bb3de207437079569435492d7be02d552b799628))
